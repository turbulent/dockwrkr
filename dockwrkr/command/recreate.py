...
class Recreate(Command):
  ...
  def getUsage(self):
    return "dockwrkr recreate [options] CONTAINER..."

  def getHelpTitle(self):
    return "Stop, Remove and Start the specified container(s)"
  ...
  def main(self):
    ...
    return self.core.recreate(self.args, all=self.getOption('allc'), time=self.getOption('time')) \
